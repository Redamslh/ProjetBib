...
public class ExemplaireDao {
	...
	public ExemplaireDao() throws Exception {
		name="root";  
        pass="";  
		url ="jdbc:mysql://localhost/biblio?zeroDateTimeBehavior=CONVERT_TO_NULL&serverTimezone=UTC";
    ...
    public void updateCombo(JComboBox cb) throws Exception{
    	PreparedStatement myStmt = null;
		ResultSet myRs = null;
    	String sql="\r\n" + 
    			"\r\n" + 
    			"Select NO from oeuvres ";
    		myStmt=myConn.prepareStatement(sql);
    		myRs=myStmt.executeQuery();
    		while(myRs.next()) {
    			cb.addItem(myRs.getInt("NO"));
    		}
