...
public class AdherentModel extends AbstractTableModel {
    ...
    public AdherentModel() {
        ...
        try {
            ...
            courseListRowSet.setCommand("select adherents.* from adherents where adherents.role=\"adherent\"");
    ...
    public AdherentModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (courseListRowSet.next()) {
                if (courseListRowSet.getString("NA").equals(array[1]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                ...
                courseListRowSet.moveToInsertRow();
                courseListRowSet.updateString("login", (String) array[0]);
                courseListRowSet.updateString("NA", (String) array[1]);
                courseListRowSet.updateString("nom", (String) array[2]);
                courseListRowSet.updateString("prenom", (String) array[3]);
                courseListRowSet.updateString("adr", (String) array[4]);
                courseListRowSet.updateString("tel", (String) array[5]);
                courseListRowSet.updateString("motdepasse", (String) array[6]);
                courseListRowSet.updateString("role", (String) array[7]);
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedCourseNumber = courseListRowSet.getString("NA");
            ...
            JOptionPane.showMessageDialog(null,
                    "Cannot have multiple records with the same primary key (NA).",
                    "Primary Key Error", JOptionPane.ERROR_MESSAGE);
    ...
    public boolean isValidEnrollmentField(Object[] array) {
        try {
            Integer.valueOf((String) array[1]).intValue();
            return true;
