...
public class ExemplaireModel extends AbstractTableModel {
    ...
    public ExemplaireModel() {
        ...
        try {
            ...
            courseListRowSet.setCommand("SELECT * FROM livres");
    ...
    public ExemplaireModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (courseListRowSet.next()) {
                if (courseListRowSet.getString("NL").equals(array[0]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                ...
                courseListRowSet.updateString("editeur", (String) array[1]);
                courseListRowSet.updateString("NO", (String) array[2]);
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedCourseNumber = courseListRowSet.getString("NL");
