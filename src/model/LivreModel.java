...
public class LivreModel extends AbstractTableModel {
    ...
    public LivreModel() {
        ...
        try {
            ...
            courseListRowSet.setCommand("SELECT * FROM oeuvres");
    ...
    public LivreModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                ...
                courseListRowSet.moveToInsertRow();
                courseListRowSet.updateString("NO", (String) array[0]);
                courseListRowSet.updateString("titre", (String) array[1]);
                courseListRowSet.updateString("auteur", (String) array[2]);
                courseListRowSet.updateString("nbrePage", (String) array[3]);
