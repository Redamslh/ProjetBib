...
public class ActualEmpruntModel extends AbstractTableModel {
    ...
    public ActualEmpruntModel() {
        ...
        try {
            ...
            courseListRowSet.setCommand("select livres.NL as numexemplaire,oeuvres.titre as oeuvre,emprunter.dateEmp,adherents.nom,adherents.prenom,adherents.tel from oeuvres,livres,adherents,emprunter where oeuvres.NO=livres.NO and adherents.NA=emprunter.NA and livres.NL=emprunter.NL and emprunter.dateRet='Pas encore retourné' ");
    ...
    public ActualEmpruntModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (courseListRowSet.next()) {
                if (courseListRowSet.getString("NA").equals(array[0]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                ...
                courseListRowSet.moveToInsertRow();
                courseListRowSet.updateString("NL", (String) array[0]);
                courseListRowSet.updateString("dateEmp", (String) array[1]);
                courseListRowSet.updateString("dateRet", (String) array[2]);
                courseListRowSet.updateString("NA", (String) array[3]);
                ...
                JOptionPane.showMessageDialog(null,
                        "Cannot have multiple records with the same primary key (id).",
    ...
    public void deleteRow(Object[] array) {
        try {
            courseListRowSet.beforeFirst();
            while (courseListRowSet.next()) {
                if (courseListRowSet.getString("NO").equals(array[0])) {
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedCourseNumber = courseListRowSet.getString("NO");
            ...
            JOptionPane.showMessageDialog(null,
                    "Cannot have multiple records with the same primary key (NL).",
                    "Primary Key Error", JOptionPane.ERROR_MESSAGE);
