...
public class ExemplaireController implements ListSelectionListener, RowSetListener {
    
    private ExemplaireModel tableModel = null;
    private ExemplaireGui gui;
    
    public ExemplaireController(ExemplaireGui gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new ExemplaireModel();
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new ExemplaireModel(tableModel.getRowSet(), tableModel.getConnection());
