...
public class AdherentController<gui> implements ListSelectionListener, RowSetListener {
    
    private AdherentModel tableModel = null;
    private AdherentGui gui;
    
    public AdherentController(AdherentGui gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new AdherentModel();
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (!e.getValueIsAdjusting()) {
            ...
            gui.setTextField((String) tableModel.getValueAt(firstIndex, 4));
            gui.setTextField1((String) tableModel.getValueAt(firstIndex, 5));
            gui.setTextField2((String) tableModel.getValueAt(firstIndex, 6));
            gui.setTextField3((String) tableModel.getValueAt(firstIndex, 7));
        }
    }
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new AdherentModel(tableModel.getRowSet(), tableModel.getConnection());
