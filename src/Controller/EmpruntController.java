...
public class EmpruntController implements ListSelectionListener, RowSetListener {
    
    private EmpruntModel tableModel = null;
    private EmpruntGui gui;
    
    public EmpruntController(EmpruntGui gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new EmpruntModel();
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new EmpruntModel(tableModel.getRowSet(), tableModel.getConnection());
