...
import model.ActualEmpruntModel;
import model.EmpruntModel;
import view.ActualEmpruntGui;
...
public class ActualEmpruntController implements ListSelectionListener, RowSetListener {
    
    private ActualEmpruntModel tableModel = null;
    private ActualEmpruntGui gui;
    
    public ActualEmpruntController(ActualEmpruntGui gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new ActualEmpruntModel();
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new ActualEmpruntModel(tableModel.getRowSet(), tableModel.getConnection());
